  ...
  Textbox.say(Trainers.ionar_boss.intro, () => {
    ...
    Game.startTrainerBattle(Trainers.ionar_boss, () => {
      ...
      Textbox.say([Trainers.ionar_boss.name + ': ' + Trainers.ionar_boss.loss,
        ...
        '(Magnus flees down the spire. Above the altar, the aurora gathers into a single blazing shape — AURORYX, wings spread wide.)',
        '(Prof. Aspen\'s voice crackles over your radio: "I gave you Ultraorbs — approach the altar and CATCH it, or Norvenna\'s sky will never be calm again!")'], Scripts.done);
    });
  });
});
